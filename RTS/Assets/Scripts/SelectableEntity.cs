...
public class SelectableEntity : Entity
{
    ...
    [SerializeField] Transform m_selectIndicator;
    ...
    public virtual void Clone(SelectableEntity newOne)
    {
    ...
    {
        base.Init();
        m_selectIndicator.gameObject.SetActive(false);
    ...
    public void OnClick(out SelectableEntity clicked)
    {
        clicked = null;
        if (m_isConstructed)
            return;
        ...
        m_selectIndicator.gameObject.SetActive(true);
